...
import argparse
import csv
from data_process.data_proc import query_format
import logging
import os
import random
import sys
    ...
    for example in features:
        ...
        if example.token_tag_sequence_b != None:
            ...
            for idx, query_tag_ids in enumerate(tag_ids_list_a):
                ...
                while len(input_tag_id) < max_seq_length:
                    input_tag_id.append(0)
                if len(input_tag_id) > max_seq_length:
                    input_tag_id = input_tag_id[:max_seq_length]
                    input_tag_id[-1] = 2 
...
def main():
    ...
    parser.add_argument("--task_desc",
                    type=str,
                    help="The description of the task ,used for log file name.")
